...
<div class="container-fluid">
  <div class="row mt-4">
       <form class="form-inline ml-5" action="searchorderbyid">
          ...
          <button type="submit" class="btn text-color custom-bg ml-2"><b style="color:white;">Search</b></button>
       </form>
       ...
       <a href="searchorderbydate?orderdate=<%=LocalDate.now().toString()%>&userid=<%=user.getId()%>" class="ml-2"><button class="btn text-color custom-bg ml-2"><b style="color:white;">Get Todays Order</b></button></a>
  </div>
